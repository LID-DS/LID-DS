...
if __name__ == '__main__':
    ...
    for window_size in window_sizes:
        for scenario_name in scenarios:
            ...
            timestamp = Timestamp()
            w2v = Sum([W2VEmbedding(word=inte,vector_size=enc_size,window_size=10,epochs=1000), SinusoidalEncoding(timestamp,enc_size)])
            ...
            with open(os.path.join(out_path, "ae_posenc_time_2019_results.csv"), "a") as results_csv:
                fieldnames = ["scenario",
                                "stream_window",
                                "false_positives",
                                "true_positives",
