...
def test_int_embedding():
    ...
    syscall_3 = Syscall2021("1631209047762210355 33 3686302 apache2 3686302 getuid < uid=33(www-data) ")
    syscall_4 = Syscall2021("1631209047762210355 33 3686302 apache2 3686302 unknown < uid=33(www-data) ")
